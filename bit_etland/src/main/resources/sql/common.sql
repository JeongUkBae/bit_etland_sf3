...
ALTER TABLE SHIPPERS AUTO_INCREMENT = 1000;
...
INSERT INTO IMAGES(IMG_NAME,IMG_EXTENTION,OWNER) VALUES('default_photo','jpg','관리자');
INSERT INTO IMAGES(IMG_NAME,IMG_EXTENTION,OWNER) VALUES('product_default','jpg','관리자');

INSERT INTO EMPLOYEES(MANAGER,NAME,BIRTH_DATE,PHOTO,NOTES) VALUES('매니저','김경민','1990.01.05','1000','FD');

INSERT INTO SUPPLIERS(SUPPLIER_NAME,CONTACT_NAME,ADDRESS,CITY,POSTAL_CODE,COUNTRY,PHONE) VALUES('삼성','이재용','메탄동','수원','6256','한국','02-156-1513');


INSERT INTO CATEGORIES(CATEGORY_NAME,DESCRIPTION) VALUES('SmartPhone','da');
INSERT INTO CATEGORIES(CATEGORY_NAME,DESCRIPTION) VALUES('Desktop','dest');
INSERT INTO CATEGORIES(CATEGORY_NAME,DESCRIPTION) VALUES('NoteBook','smart');

INSERT INTO PRODUCTS(PRODUCT_NAME,SUPPLIER_ID,UNIT,PRICE) VALUES('갤럭시',1000, '100','20000');
